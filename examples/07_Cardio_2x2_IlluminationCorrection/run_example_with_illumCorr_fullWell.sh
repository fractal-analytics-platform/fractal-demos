LABEL="with_illum_corr_fullWell_FOV-v2_cellpose_highres"
...
fractal workflow add-task $WF_ID "Create OME-Zarr structure" --args-file Parameters/args_create_ome_zarr_illum_corr.json --meta-file Parameters/example_meta.json
