...
fractal --batch workflow add-task $PRJ_ID $WF_ID --task-name "Convert 2D Segmentation to 3D" --args-file Parameters/args_convert_2D_to_3D.json
fractal --batch workflow add-task $PRJ_ID $WF_ID --task-name "Convert Metadata Components from 2D to 3D"
fractal --batch workflow add-task $PRJ_ID $WF_ID --task-name "Cellpose Segmentation" --args-file Parameters/args_cellpose_segmentation.json #--meta-file Parameters/cellpose_meta.json
