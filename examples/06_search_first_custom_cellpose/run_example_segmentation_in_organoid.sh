...
fractal --batch workflow add-task $WF_ID "Create OME-Zarr structure" --args-file Parameters/create_zarr_structure.json
...
fractal --batch workflow add-task $WF_ID "Cellpose Segmentation" --args-file Parameters/cellpose_segmentation_overlap.json --meta-file Parameters/cellpose_meta.json
...
fractal --batch workflow add-task $WF_ID "Cellpose Segmentation" --args-file Parameters/cellpose_segmentation_nuclei.json --meta-file Parameters/cellpose_meta.json
