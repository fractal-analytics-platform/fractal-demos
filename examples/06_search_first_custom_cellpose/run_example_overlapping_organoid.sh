...
OUTPUT_PATH=/data/active/jluethi/Fractal/20230220_organoids_overlap-v4
###############################################################################
...
# TODO: Change parameters to run on the organoid ROIs once this is enabled
