LABEL="cardio-2x2-zenodo-subset-v1"
...
fractal workflow add-task $WF_ID "Create OME-Zarr structure" --args-file Parameters/create_zarr_structure_image_subset.json
