LABEL="cardio-2x2-zenodo-subset-12"
...
fractal --batch workflow add-task $PRJ_ID $WF_ID --task-name "Create OME-Zarr structure" --args-file Parameters/create_zarr_structure_image_subset.json --meta-file Parameters/example_meta.json
