LABEL="202317_23well_Cardiomyocytes_FOV1-${1}"
...
fractal workflow add-task $WF_ID "Cellpose Segmentation" --args-file Parameters/cellpose_segmentation.json --meta-file Parameters/gpu_meta.json
