LABEL="cardio-2x2_multi_workflow_3"
...
# Workflow 2: 
echo "{\"level\": 0, \"ROI_table_name\": \"well_ROI_table\", \"workflow_file\": \"$PROJ_DIR/../np_wf_2_label.yaml\", \"input_specs\": {\"slice_img\": {\"type\": \"image\", \"channel\": \"A01_C01\"}, \"slice_img_c2\": {\"type\": \"image\", \"channel\": \"A02_C03\"}}, \"output_specs\": {\"Result of Expand labels (scikit-image, nsbatwm)\": {\"type\": \"label\",\"label_name\": \"wf_2_labels\"}}}" > Parameters/measurement2.json
