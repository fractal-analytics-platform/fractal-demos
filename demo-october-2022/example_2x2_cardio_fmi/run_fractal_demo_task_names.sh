...
# Set a unique name prefix to ensure all names are unique
UNIQUE_NAME = ''

# Set useful variables
PRJ_NAME=$UNIQUE_NAME"_myproj"
DS_IN_NAME=$UNIQUE_NAME"_input-ds"
DS_OUT_NAME=$UNIQUE_NAME"_output-ds"
WF_NAME=$UNIQUE_NAME"_WF-2x2"
